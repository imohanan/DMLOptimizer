...
//						 System.out.println ("OSS: "+ osline);
						...
						_outPrint.print( stats[1].substring(stats[1].indexOf("\"") + 1,stats[1].lastIndexOf("\"")) + ",");						
						_outPrint.flush();
						cpu="CPU:"+ stats[2].substring(stats[2].indexOf("\"") + 1,stats[2].lastIndexOf("\"")) + ",";
						_outPrint.print(stats[2].substring(stats[2].indexOf("\"") + 1,stats[2].lastIndexOf("\"")) + ",");						
						_outPrint.flush();
						disk="DISK:"+ stats[3].substring(stats[3].indexOf("\"") + 1,stats[3].lastIndexOf("\"")) + ",";
						_outPrint.print( stats[3].substring(stats[3].indexOf("\"") + 1,stats[3].lastIndexOf("\"")) + ",");						
						_outPrint.flush();
						double net=Double.parseDouble(stats[4].substring(stats[4].indexOf("\"") + 1,stats[4].lastIndexOf("\"")));
						net=net/(1024*1024);
						network="NTBW(MB/sec):"+ net + ",";
						_outPrint.println(stats[4].substring(stats[4].indexOf("\"") + 1,stats[4].lastIndexOf("\"")) + ",");
						_outPrint.flush();
